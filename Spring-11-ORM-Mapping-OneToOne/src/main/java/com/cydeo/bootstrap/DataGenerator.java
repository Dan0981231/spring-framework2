...
DepartmentRepository departmentRepository;
    ...
    public void run(String... args) throws Exception {
        ...
        com.cydeo.entity.Region r1 = new com.cydeo.entity.Region("Southwest","United States");
        com.cydeo.entity.Region r2 = new com.cydeo.entity.Region("Central","United States");
        com.cydeo.entity.Region r3 = new com.cydeo.entity.Region("Northwest","United States");
        com.cydeo.entity.Region r4 = new com.cydeo.entity.Region("Quebec'","Canada");
        com.cydeo.entity.Region r5 = new Region("Central","Asia");
